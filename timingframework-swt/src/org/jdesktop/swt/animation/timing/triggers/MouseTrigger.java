 ...
 * 
 * <pre>
 * MouseTrigger trigger = MouseTrigger.addTrigger(control, anim, MouseTriggerEvent.ENTER);
 * </pre>
 * 
 * @author Chet Haase
 * @author Tim Halloran
...
public class MouseTrigger extends Trigger implements MouseListener, MouseTrackListener {
   ...
   */
  public static MouseTrigger addTrigger(Control control, Animator animator, MouseTriggerEvent event) {
   ...
   */
  public static MouseTrigger addTrigger(Control control, Animator animator, MouseTriggerEvent event, boolean autoReverse) {
