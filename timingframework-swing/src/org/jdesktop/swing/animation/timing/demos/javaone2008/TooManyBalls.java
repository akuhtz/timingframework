 ...
 * @author Tim Halloran
 */
public class TooManyBalls implements
		JRendererTarget<GraphicsConfiguration, Graphics2D> {
	...
	public TooManyBalls() {
		final String rendererType = JRendererFactory.useActiveRenderer() ? "Active"
				: "Passive";
		f_frame = new JFrame("Too Many Balls! - Swing " + rendererType
				+ " Rendering");
	...
	private void updateBallCount() {
		f_infoLabel.setText("Balls: " + f_ballCount + "    FPS: "
				+ f_renderer.getFPS());
		f_frame.validate();
	}
