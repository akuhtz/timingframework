...
public class JRendererPanel extends JPanel {
	 ...
	 *            used for passive rendering.
	 */
	void setTarget(JRendererTarget<GraphicsConfiguration, Graphics2D> target,
			TimingSource timingSource, PostTickListener postTick) {
		f_target = target;
		f_ts = timingSource;
		f_postTick = postTick;
	}
	...
	/**
	 * Clears the rendering target other passive rendering information out of
	 * this control.
	 */
	void clearTarget() {
