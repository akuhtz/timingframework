...
public final class TriggerUtility {
    ...
    /**
     * Creates a non-auto-reversing timing trigger and adds it as a target to the source animation. For example, one
     * {@link Animator} can be set to start when another ends using this trigger. For example, to have <tt>anim2</tt>
     ...
     * 
     * @param source
     *            the animation that will be listened to for events to start the target animation.
     * @param target
     *            the animation that will start when the event occurs.
     * @param event
     *            the {@link TimingTriggerEvent} on <tt>source</tt> that will cause <tt>target</tt> to start.
    ...
    /**
     * Creates a timing trigger and adds it as a target to the source animation. For example, one {@link Animator} can
     * be set to start when another ends using this trigger. For example, to have <tt>anim2</tt> start when
     * <tt>anim1</tt> ends and visa versa, have <tt>anim2</tt> stop when <tt>anim1</tt> starts, one might write the
     * following:
     * 
     * <pre>
     ...
     * @see TimingTrigger
     */
    public static Trigger addTimingTrigger(
    ...
    /**
     * Creates an action trigger and adds it as an {@link ActionListener} to the passed object. For example, to have
     * {@code anim} start when a button is clicked, one might write the following:
     * 
     * <pre>
     ...
     * 
     * @param object
     *            an object that will be used as an event source for this trigger. This object must have an
     ...
     * 
     * @throws IllegalArgumentException
     *             if either of the parameters is {@code null} or if <tt>object</tt> has no {@code addActionListener}
     *             method.
     */
    ...
    /**
     * Creates a non-auto-reversing focus trigger and adds it as a {@link FocusListener} to the passed component. For
     * example, to have {@code anim} start when {@code component} receives an IN event, one might write the following:
     * 
     * <pre>
     ...
     *            the animation that will start when the event occurs.
     * @param event
     *            the {@link FocusTriggerEvent} on <tt>component</tt> that will cause <tt>target</tt> to start.
     * @return the resulting trigger.
     * 
     * @throws IllegalArgumentException
     *             if any of the parameters is {@code null}.
    ...
    /**
     * Creates a focus trigger and adds it as a {@link FocusListener} to the passed component. For example, to have
     * {@code anim} start when {@code component} receives an IN event, and reverse {@code anim} when {@code component}
     ...
     *             if any of the parameters is {@code null}.
     */
    public static Trigger addFocusTrigger(
        JComponent component, Animator target, FocusTriggerEvent event, boolean autoReverse) {
        if (component == null) {
    ...
    /**
     * Creates a non-auto-reversing mouse trigger and adds it as a {@link MouseListener} to the passed component. For
     * example, to have {@code anim} start when {@code component} receives an CLICK event, one might write the
     * following:
     * 
     * <pre>
     ...
     *            the animation that will start when the event occurs.
     * @param event
     *            the {@link MouseTriggerEvent} on <tt>component</tt> that will cause <tt>target</tt> to start.
     * @return the resulting trigger.
     * 
     * @throws IllegalArgumentException
     *             if any of the parameters is {@code null}.
    ...
    /**
     * Creates a mouse trigger and adds it as a {@link MouseListener} to the passed component. For example, to have
     * {@code anim} start when {@code component} receives an ENTER event, and reverse {@code anim} when
     ...
     *             if any of the parameters is {@code null}.
     */
    public static Trigger addMouseTrigger(
        JComponent component, Animator target, MouseTriggerEvent event, boolean autoReverse) {
        if (component == null) {
            throw new IllegalArgumentException(I18N.err(1, "component"));
        }
        if (target == null) {
