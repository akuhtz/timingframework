...
public class AnimatorBuilder {
	 ...
	 * <p>
	 * The client code remains responsible for disposing of the timing source
	 ...
	 *            {@link Animator#INFINITE}, meaning the animation will run
	...
	public AnimatorBuilder setRepeatBehavior(Animator.RepeatBehavior value) {
		f_repeatBehavior = value != null ? value
	 ...
	 *            must be >= 1 or {@link Animator#INFINITE} for animations that
	 *            repeat indefinitely.
	 * @return this builder (to allow chained operations).
	...
	public Animator build() {
		final Animator result = new Animator(f_duration, f_durationTimeUnit,
				f_endBehavior, f_interpolator, f_repeatBehavior, f_repeatCount,
				f_startDirection, f_timingSource);
