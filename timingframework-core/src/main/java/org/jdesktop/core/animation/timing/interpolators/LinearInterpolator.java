...
public final class LinearInterpolator implements Interpolator {
    ...
    /**
     * This method always returns the value it was given, which will cause callers to calculate a linear interpolation
     * between boundary values.
     * 
     * @param fraction
     *            a value between 0 and 1, representing the elapsed fraction of a time interval (either an entire
     *            animation cycle or an interval between two KeyTimes, depending on where this {@link Interpolator} has
     *            been set)
