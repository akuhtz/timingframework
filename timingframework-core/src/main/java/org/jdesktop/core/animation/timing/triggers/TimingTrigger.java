...
/**
 * A trigger that starts an animation when an animation timing event occurs in another animation. This class can be
 * useful in sequencing different animations. For example, one {@link Animator} can be set to start when another ends
 * using this trigger. For example, to have <tt>anim2</tt> start when <tt>anim1</tt> ends, one might write the
 * following:
 * 
 * <pre>
...
public final class TimingTrigger {
     ...
     * be set to start when another ends and visa versa using this trigger. For example, to have <tt>anim2</tt> start
     * when <tt>anim1</tt> ends and visa versa, have <tt>anim2</tt> stop when <tt>anim1</tt> starts, one might write the
     * following:
     * 
     * <pre>
