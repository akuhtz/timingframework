...
public interface Evaluator<T> {
    ...
    /**
     * Evaluates between two boundary values. Typically implementations use linear parametric evaluation:
     * 
     * <pre>
     * v = v0 + (v1 - v0) * fraction
     * </pre>
     * 
     * Implementations of {@link Evaluator} will need to override this method and do something similar for their own
     * types.
     * <p>
     ...
     * through a custom {@link Interpolator} rather than perform custom calculations in this method. The point of this
     * class is to allow calculations with new/unknown types, not to provide another mechanism for non-linear
     * interpolation.
     */
