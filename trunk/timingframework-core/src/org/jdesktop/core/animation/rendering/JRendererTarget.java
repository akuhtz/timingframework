...
public interface JRendererTarget<D, G> {
	...
	/**
	 * Invoked once when the component being rendered is made visible to allow
	 * the implementation to perform any necessary setup.
	 * <p>
	...
	/**
	 * Invoked once per rendering cycle to allow the implementation to update
	 * its state.
	 * <p>
	...
	/**
	 * Invoked once per rendering cycle to allow the implementation to paint
	 * onto a graphics object that is either the screen or an off-screen image
	 * that will subsequently painted onto the screen.
	 * <p>
