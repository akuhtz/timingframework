...
public abstract class TimingSource {
	 ...
	 * implementation is registered as a listener of the {@link TimingSource}
	 * via the {@link TimingSource#addTickListener(TickListener)} method.
	 * <p>
	...
	public interface TickListener {
		 ...
		 * timer is running. It indicates a tick of time has passed.
		 * 
		 * @param source
		 *            the object that invoked this call.
		 * @param nanoTime
		 *            the current value of the most precise available system
	 ...
	 * {@link PostTickListener} implementation is registered as a listener of
	 * the {@link TimingSource} via the
	...
	public interface PostTickListener {
		...
		/**
		 * This method is called by the {@link TimingSource} object while the
		 * timer is running. It indicates a tick of time has passed and that all
	...
	public interface TickListenerNotificationContext {
		 ...
		 * {@link TimingSource} object. The default implementation is shown
		 * below.
		 * 
		 * <pre>
		 ...
		 * </pre>
		 * 
		 * This default implementation notifies listeners in the thread context
		 * of the {@link TimingSource} object. Other implementations could
		 * ensure that listeners are notified in any thread context. For
		 * example, within the Swing EDT or the SWT EDT.
		 * 
		 * @param source
		 *            the object that invoked this call.
		 */
	 ...
	 * timing events from this {@link TimingSource}. Has no effect if the
	 * listener is not in the set of listeners.
	 * 
	 * @param listener
	...
	/**
	 * Adds a {@link PostTickListener} to the set of listeners that receive
	 * timing events from this {@link TimingSource}. Has no effect if the
	...
	/**
	 * This method notifies this object's {@link TickListener}s and,
	 * subsequently, {@link PostTickListener}s that a tick of time has elapsed.
	 * <p>
	 * This method should only be invoked by implementations of
	 * {@link TickListenerNotificationContext}. <b>Clients should not invoke
	 * this method in any other context.</b>
	 * 
	...
	/**
	 * This method notifies this object's {@link TickListener} objects that a
	 * tick of time has elapsed by calling through the object's
