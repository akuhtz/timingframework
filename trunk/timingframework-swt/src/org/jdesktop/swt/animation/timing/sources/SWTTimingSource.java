...
public final class SWTTimingSource extends TimingSource {
	 ...
	 *            the time unit of period parameter.
	 * @param display
	 *            the display that manages the connection between SWT timing and
	 *            the underlying operating system. May be {@code null}, in which
	 *            case {@link Display#getDefault()} is invoked when
	 *            {@link #init()} is called on this timer.
	 */
