...
public final class DemoResources {
	...
	public static final String[] SPHERES = { BLUE_SPHERE, GRAY_SPHERE,
			GREEN_SPHERE, RED_SPHERE, YELLOW_SPHERE };

	private static final String PREFIX = "org/jdesktop/swt/animation/timing/demos/";
