 ...
 * 
 * <pre>
 * FocusTrigger trigger = FocusTrigger.addTrigger(control, anim,
...
public class FocusTrigger extends Trigger implements FocusListener {
	 ...
	 */
	public static FocusTrigger addTrigger(Control control, Animator animator,
	...
	/**
	 * Creates a non-auto-reversing {@link FocusTrigger}, which should be added
	...
	/**
	 * Called by the object which added this trigger as a {@link FocusListener}.
	 * This method starts the animator if the trigger is waiting for a OUT
	 * event.
	 */
